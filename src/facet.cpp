...
Facet::Facet(QWidget *parent, int FType, double FThickness, QColor FColor):QDialog(parent),
    ui(new Ui_Facet), mustBeRestored(true)
...
void Facet::on_cancelButton_clicked()
{
    close();
}
